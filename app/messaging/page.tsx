...
function MessagingContent() {
  ...
  if (!user) return <div className="h-screen flex items-center justify-center">Loading Auth...</div>;

  return (
    <div className="flex h-[calc(100vh-64px)] w-full bg-[#f0f2f5] relative overflow-hidden font-sans">
